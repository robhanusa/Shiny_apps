...
order_1 <- c('mat_1' = ifelse(include_order1,100,0),
             'mat_2' = ifelse(include_order1,100,0),
             'week' = 10)
order_2 <- c('mat_1' = ifelse(include_order2,100,0),
             'mat_2' = ifelse(include_order2,100,0),
             'week' = 24 )
order_3 <- c('mat_1' = ifelse(include_order3,400,0),
             'mat_2' = ifelse(include_order3,100,0),
             'week' = 34)
...
stock1 <- calc_stock(200,cons1_tot,'mat_1')
stock2 <- calc_stock(100,cons2_tot,'mat_2')
...
# vline_list <- list()
# if(include_order1){
#   list <- append(vline_list,list(vline(order_1['week']),
#                                  vline(order_1['week'] - lead_time, color = 'red')))
# }
# if(include_order2){
#   list <- append(vline_list,list(vline(order_2['week']),
#                                  vline(order_2['week'] - lead_time, color = 'red')))
# }
# if(include_order3){
#   list <- append(vline_list,list(vline(order_3['week']),
