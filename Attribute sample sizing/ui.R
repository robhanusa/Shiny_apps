...
ui <- fluidPage(
  ...
  p("Calculate sample size as a function of reliability requirements for categorical measurements. This tool also lets a few failure be taken into account."),
